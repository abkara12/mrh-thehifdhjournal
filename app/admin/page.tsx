...
function SkeletonCard() {
  return (
    <div className="rounded-3xl border border-gray-200 bg-white/60 backdrop-blur p-6 shadow-sm">
      <div className="h-4 w-28 bg-[#5B726D]/10 rounded-full animate-pulse" />
      <div className="mt-3 h-8 w-2/3 bg-[#5B726D]/10 rounded-2xl animate-pulse" />
      <div className="mt-6 grid gap-3">
        <div className="h-12 w-full bg-[#5B726D]/10 rounded-2xl animate-pulse" />
        <div className="h-12 w-full bg-[#5B726D]/10 rounded-2xl animate-pulse" />
      </div>
    </div>
  );
    ...
    >
      <div className="grid gap-6">
        <div className="rounded-3xl border border-gray-200 bg-white/70 backdrop-blur p-7 shadow-sm">
          ...
          <div className="mt-6 grid gap-3">
            <label className="text-sm font-semibold text-[#5B726D]">
              Students
            </label>
            ...
            <div className="relative">
              <select
                ...
                className="w-full h-12 rounded-2xl border border-gray-200 bg-white/80 px-4 pr-10 outline-none focus:ring-2 focus:ring-[#A46B72]/30"
        ...
        <div className="rounded-3xl border border-gray-200 bg-white/60 backdrop-blur p-6 shadow-sm">
          <div className="text-sm font-semibold text-[#5B726D]">
